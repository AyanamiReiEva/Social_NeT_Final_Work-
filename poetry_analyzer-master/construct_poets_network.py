...
def get_refer_relations(qts_list, authors_filtered_by_CBDB, alter_names_dict, save_dir):
  ...
  if os.path.exists(reference_relations_file):
    ...
    reference_relations_counter = Counter()#计数函数
...
def main():
  ...
  parser.add_argument('--qts_path', type=str, default='static/qts_zht.txt',
                      help='file path of Quan Tangshi')
  parser.add_argument('--cbdb_path', type=str, default='static/cbdb_sqlite.db',
                      help='file path of CBDB')
  parser.add_argument('--save_dir', type=str, default='save',
                      help='directory to pickle intermediate static')
